 ...
 * @license AGPL-3.0
 * Blooket Cheats
 * Copyright (C) 2024-present Hunkon
 ...
 * 
 * Source: https://github.com/bobreed24/blookethacks/ alex@ayxia.com
*/
...
(() => {
    ...
    const cheat = (async () => {
        ...
        let settings, settingsKey = "HunkonWasHere";
        const Settings = {
            data: null,
            setItem(k, v) {
        ...
        const guiWrapper = createElement("div", {
            ...
            (gui = createElement("div", {
                ...
                createElement("div", {
                    ...
                    innerHTML: "GitHub - Hunkon",
                    onclick: () => window.open("https://github.com/bobreed24/blookethacks/", "_blank").focus()
                }),
